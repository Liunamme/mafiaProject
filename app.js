...
mafiaBtn09.onclick = () => {
  randomRoleMassive = []
  randomRoleMassive = ['Мирный житель🙍‍♂️','Мирный житель🙍‍♂️','Мафия🔫','Мирный житель🙍‍♂️','Мирный житель🙍‍♂️','Комиссар🤠','Мирный житель🙍‍♂️','Мирный житель🙍‍♂️','Дон🕵🏻']
// Run
for (let i = 0; i < 30; i++) {
...
mafiaBtn11.onclick = () => {
  randomRoleMassive = []
  randomRoleMassive = ['Доктор💉','Мирный житель🙍‍♂️','Мирный житель🙍‍♂️','Мафия🔫','Мирный житель🙍‍♂️','Комиссар🤠','Дон🕵🏻','Мирный житель🙍‍♂️','Мирный житель🙍‍♂️','Мафия🔫','Мирный житель🙍‍♂️']
// Run
for (let i = 0; i < 30; i++) {
  shuffle(randomRoleMassive);
}
...
mafiaBtn12.onclick = () => {
  randomRoleMassive = []
  randomRoleMassive = ['Дон🕵🏻','Мирный житель🙍‍♂️','Мафия🔫','Мирный житель🙍‍♂️','Комиссар🤠','Мирный житель🙍‍♂️','Мафия🔫','Мирный житель🙍‍♂️','Доктор💉','Мафия🔫','Мирный житель🙍‍♂️','Любовница💖']
// Run
for (let i = 0; i < 30; i++) {
  shuffle(randomRoleMassive);
}
...
mafiaBtn13.onclick = () => {
  randomRoleMassive = []
  randomRoleMassive = ['Мафия🔫','Мирный житель🙍‍♂️','Мафия🔫','Мирный житель🙍‍♂️','Комиссар🤠','Мирный житель🙍‍♂️','Дон🕵🏻','Мирный житель🙍‍♂️','Доктор💉','Мафия🔫','Мирный житель🙍‍♂️','Любовница💖','Маньяк🔪']
// Run
for (let i = 0; i < 30; i++) {
  shuffle(randomRoleMassive);
}
...
mafiaBtn14.onclick = () => {
  randomRoleMassive = []
  randomRoleMassive = ['Мафия🔫','Мирный житель🙍‍♂️','Мафия🔫','Оборотень🧟','Комиссар🤠','Мирный житель🙍‍♂️','Мафия🔫','Мирный житель🙍‍♂️','Доктор💉','Дон🕵🏻','Мирный житель🙍‍♂️','Любовница💖','Маньяк🔪','Мирный житель🙍‍♂️']
// Run
for (let i = 0; i < 30; i++) {
  shuffle(randomRoleMassive);
}
